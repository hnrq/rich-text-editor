...
const renderBlockButton = (children?: string, format: BlockEnum = BLOCKS[0]) => render(
    <ThemeProvider theme={theme}><BlockButton format={format}>{children}</BlockButton></ThemeProvider>
    );
